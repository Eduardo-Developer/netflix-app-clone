package com.eduardo.netflix.util;
...
import com.eduardo.netflix.model.Category;
import com.eduardo.netflix.model.Movie;
...
public class CategoryTask extends AsyncTask<String, Void, List<Category>> {
    ...
    protected List<Category> doInBackground(String... params) {
        ...
        try {
            ...
            HttpsURLConnection urlConnection = (HttpsURLConnection) resquestUrl.openConnection();
